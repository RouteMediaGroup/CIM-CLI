...
namespace Cim\Modules {
    ...
    class RunProject extends \Cimply\Service\Cli\Base
    {
         ...
         * @Info This Modul rund your angular-project
        ...
        final private function menu(): void {
            ...
            print "-------------------------------------------------------------------------"; 
            print "\n\r";
            self::$projects = self::LoadProject(".\\frontend\\");
        ...
        private function execute($projectName = null) {
            $baseDir = "assets\\{$projectName}";
            if((bool)(system("cd frontend\\{$projectName} && ng serve"))) {
